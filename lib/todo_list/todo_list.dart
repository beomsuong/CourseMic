...
class ToDoList extends StatefulWidget {
  ...
  late final ToDoListState myState;
...
class ToDoListState extends State<ToDoList> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: widget.miniToDoState != null
            ? PreferredSize(
                        ...
                        onPressed: () => Navigator.push(
                            ...
                            MaterialPageRoute(
                                builder: (context) => ToDoCalendar(
                                      chatDataState: widget.chatDataState,
                                      todoDataState: this,
                                    ))),
        ...
        body: StreamBuilder(
            ...
            builder: (context, AsyncSnapshot<StateWithToDo> snapshot) {
              if (!snapshot.hasData) {
                return const Center(
                    child:
                        CircularProgressIndicator(color: Palette.pastelPurple));
              }
